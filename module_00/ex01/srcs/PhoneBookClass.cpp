...
/*   Updated: 2022/07/29 11:29:38 by nburat-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void PhoneBook::add_contact(int i)
{
	...
	{
		std::cout << "First Name : ";
		if (std::cin.eof() || std::getline(std::cin, first_name) == NULL)
		{
	...
	{
		std::cout << "Last name : ";
		if (std::cin.eof() || std::getline(std::cin, last_name) == NULL)
		{
			std::cout << std::endl << "Goodbye" << std::endl;
			exit(1);
		}
	...
	{
		std::cout << "Nickname : ";
		if (std::cin.eof() || std::getline(std::cin, nickname) == NULL)
		{
			std::cout << std::endl << "Goodbye" << std::endl;
			exit(1);
		}
	...
	do
	{
		...
		if (std::cin.eof() || std::getline(std::cin, phone_number) == NULL)
		{
			std::cout << std::endl << "Goodbye" << std::endl;
			exit(1);
		}
	...
	do
	{
		...
		if (std::cin.eof() || std::getline(std::cin, darkest_secret) == NULL)
		{
			std::cout << std::endl << "Goodbye" << std::endl;
			exit(1);
		}
...
void PhoneBook::display_contact_info(void) const
{
	...
	std::cout << std::endl
			  << "Which contact number do you want to display ?" << std::endl;
