...
/*   Updated: 2022/08/09 16:52:52 by nburat-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(AForm& form)
{
	...
	{
		std::cerr << this->getName() << " couldn't signe " << form.getName() << " cause " << e.what() << std::endl;
	}
}
...
void Bureaucrat::executeForm(AForm const & form)
{
	...
	{
		std::cerr << this->getName() << " couldn't execute " << form.getName() << " cause " << e.what() << std::endl;
	}
}
